...
class Base_Datos:
    ...
    def __init__(self): # Creacion del constructor 
...
# Crea la tabla donde se almaceran los favoritos de los usuario
    ...
    def crea_Tabla_Favoritos(self):
        ...
        self.db.commit()
        print ("Tabla favoritos ha sido creada con éxito")

        
    # Metodo que recibe los parametros de la aplicacion y por medio de ellos se insertan en la base de datos 
    ...
    # Metodo que recibe los parametros de la aplicacion y por medio de ellos  se insertan en la base de datos se realiza la busqueda
    ...
    # Metodo encargado de realizar las busquedas, tanto por facilida, caracteristicas, precio y orden, ademas recibe un ASC o un DESC
    def busqueda_Apartamentos(self,pFacilidades,pCaracteristicas,pUbicacion,pPrecio,pOrden):
        ...
        if (pPrecio != ""):
            for facilidad in lista_Facilidades: # Recorre las lista facilidades 
            ...
            for caracteristica in lista_Caracteristicas:# Recorre las lista facilidades 
        ...
        # Realiza ordenimiendo de precios 
        if pOrden== 'ASC':
...
def main():
    base= Base_Datos()
    print("Bienvenido al sistema de Base de datos")    
    #base.crea_Tabla_Favoritos()
    #base.crea_Tabla_Apartamentos()
